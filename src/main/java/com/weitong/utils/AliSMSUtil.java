...
public class AliSMSUtil {
	...
	public static boolean sendMessge(String tel, String templateCode, Map<String, Object> tempalteParams){
	    try {
			...
			//TODO 替换成你的AK
			final String accessKeyId = "LTAILigxifhjMEHl";//你的accessKeyId,参考本文档步骤2
			final String accessKeySecret = "hW9u6meuRlVgvIaEClSRWRH0qvk4j8";//你的accessKeySecret，参考本文档步骤2
